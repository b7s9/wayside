...
//  Intro
    -   Note: this is a demo story written in Ink. It's just here so we can figure out the interactivity/buttons and stuff; obviously we'll put our own writing here later on.
    *   [Okay! Start the story please!]
